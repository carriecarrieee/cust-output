...
class CustomerData:
    ...
    def transform_data(self):
        """ Reads the input file and returns the data as a list of items.
        """
    ...
    @staticmethod
    def pad_zeroes(string, digits):
        """ Takes string and pads it with leading zeroes.

            Test:

            >>> CustomerData.pad_zeroes('45', 6)
            '000045'

            >>> CustomerData.pad_zeroes('1003', 5)
            '01003'
        """
    ...
    def convert_to_int(string):
        """ Takes a string of a positive or negative number and converts it to
            ...
            Test:
            >>> CustomerData.convert_to_int('1,232')
            1232

            >>> CustomerData.convert_to_int('(121)')
            -121
        """
    ...
    def convert_date(string):
        """ Takes a string and converts it to a datetime object, then transforms
            ...
            >>> CustomerData.convert_date('Feb 25 2017')
            '20170225'

            >>> CustomerData.convert_date('Sep 2 2016 ')
            '20160902'
        """
